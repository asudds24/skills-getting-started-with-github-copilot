...
activities = {
    ...
    "Soccer Team": {
        ...
        "schedule": "Practice Mon/Wed/Fri, 4:00 PM - 6:00 PM; Matches on Saturdays",
        "max_participants": 22,
    ...
    "Basketball Club": {
        ...
        "max_participants": 18,
        "participants": ["kevin@mergington.edu", "marie@mergington.edu"]
    },
    # Artistic activities
    "Art Club": {
    ...
    "Drama Club": {
        ...
        "max_participants": 25,
        "participants": ["zara@mergington.edu", "matt@mergington.edu"]
    },
    # Intellectual activities
    "Debate Team": {
        "description": "Public speaking, argumentation, and competitive debating",
        "schedule": "Tuesdays, 3:30 PM - 5:00 PM; Tournaments as scheduled",
        "max_participants": 16,
